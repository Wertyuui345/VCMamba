...
parser.add_argument('--model', default='VCMamba_EfficientFormer_B', type=str, metavar='MODEL',
                help='Name of model to train (default: "VCMamba_EfficientFormer_B"')
parser.add_argument(
...
def main():
    ...
    # Not needed, init_weights is already mnaually called in the model unless we want to call it twice
    model.init_weights()
