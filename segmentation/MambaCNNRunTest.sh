...
then
    ...
    NCCL_DEBUG=INFO RANK=0 python -m torch.distributed.launch --nproc_per_node 1 --nnodes 1 --master_addr=$MASTER_ADDR --node_rank 0 --master_port=3456 --use_env train.py configs/sem_fpn/fpn_mcnn_b_ade20k_40k.py --resume-from semantic_results/MambaCNN_B/BEST_TEST_MambaCNN_B_4709.pth --model VCMamba_EfficientFormer_B --work-dir semantic_results/MambaCNN_B/ --launcher pytorch > semantic_results/MambaCNN_B_run_semantic.txt
