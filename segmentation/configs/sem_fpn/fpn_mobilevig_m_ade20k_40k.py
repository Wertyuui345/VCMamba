...
model = dict(
    ...
    backbone=dict(
        ...
        init_cfg=dict(
            type='Pretrained',
            checkpoint='../../../../MobileViG/Pretrained_Models_MobileViG/MobileViG_M_80_7.pth.tar',
        ),
    ),
    neck=dict(in_channels=[42, 84, 224, 400]),
    decode_head=dict(num_classes=150))

gpu_multiples = 1  # used to be 2 # we use 8 gpu instead of 4 in mmsegmentation, so lr*2 and max_iters/2
# optimizer
