model = dict(
    ...
    backbone=dict(
        ...
        init_cfg=dict(
            type='Pretrained',
            checkpoint=
            '../Results/S_GreedyViG_Depth_Incr_ADA_8_GPUs/model_best.pth')),
    neck=dict(
        type='FPN',
...
log_level = 'INFO'
load_from = None
resume_from = 'detection_results/epoch_11_42_74_39_21.pth'
workflow = [('train', 1)]
work_dir = 'detection_results/'
auto_resume = False
gpu_ids = range(0, 8)
