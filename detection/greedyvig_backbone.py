...
if has_mmdet:
    ...
    def greedyvig_s_feat(pretrained=True, **kwargs):
        model = GreedyViG(blocks=[[2,2], [2,2], [6,2], [2,2]],
                        ...
                        num_classes=1000,
                        out_indices=[0, 1, 2, 3],
                        pretrained='../Results/S_GreedyViG/S2/S_GreedyViG_81_1.pth')
        model.default_cfg = default_cfgs['greedyvig']
        return model

    @det_BACKBONES.register_module()
    def greedyvig_s_depth_feat(pretrained=True, **kwargs): ## 12.5 M
        model = GreedyViG(blocks=[[5,5], [5,5], [15,5], [5,5]],
                        ...
                        num_classes=1000,
                        out_indices=[0, 1, 2, 3],
                        pretrained='../Results/S_GreedyViG_Depth_Incr_ADA_8_GPUs/model_best.pth')
        model.default_cfg = default_cfgs['greedyvig']
        return model
    ...
    def greedyvig_b_feat(pretrained=True, **kwargs):
        model = GreedyViG(blocks=[[4,4], [4,4], [12,4], [3,3]],
                        ...
                        num_classes=1000,
                        out_indices=[0, 1, 2, 3],
                        pretrained='../Results/B_83_9_model_best.pth')
        model.default_cfg = default_cfgs['greedyvig']
        return model