...
def get_args_parser():
    ...
    # Model parameters
    parser.add_argument('--model', default='efficientformerv2_l', type=str, metavar='MODEL',
    ...
    # #Additional arguments for working with CPU
...
def main(args):
    ...
    #For comparison with efficientformer, use args.distributed
    if args.distributed:
